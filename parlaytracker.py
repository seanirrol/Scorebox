...
def _tracker_modules():
    ...
    return {
        ...
        "inningtotaltracker": inningtotaltracker,
...
def resolve_leg(message_id: int) -> Optional[tuple[str, str, int]]:
    ...
    owner = mods["inningtotaltracker"].get_message_owner(message_id)
    if owner:
        channel_id, game_id, pick_type, line, _owner_id = owner
        return "inningtotaltracker", mods["inningtotaltracker"].track_key(channel_id, game_id, pick_type, line), channel_id
    ...
    owner = mods["snookertracker"].get_message_owner(message_id)
    if owner:
        channel_id, match_id, market, team, _owner_id = owner
        key = mods["snookertracker"].track_key(channel_id, match_id, market, team)
        return "snookertracker", key, channel_id
