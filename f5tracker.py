    ...
    try:
        while time.monotonic() < deadline:
            ...
            if breakdown is not None:
                ...
                if result:
                    await parlaytracker.handle_leg_result(
                        message.channel, channel_id, message, "f5tracker", key, leg_label, result, carry_emojis,
                    )
                break
            ...
            if marker_emojis:
                ...
                await parlaytracker.report_leg_progress(
                    message.channel, channel_id, message, "f5tracker", key, leg_label, detail, marker_emojis,
                )
